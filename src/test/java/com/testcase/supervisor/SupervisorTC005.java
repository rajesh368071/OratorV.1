...
public class SupervisorTC005 extends AllScenario {
	...
	public void verify(Map<Object, Object> map) throws IOException, InterruptedException, AWTException {
		...
		supervisorChat.clickEscalate();
		Thread.sleep(2000);
		assertEquals(ElementDisplayed(supervisorChat.verifyChatStatus(firstname, "Escalated")), true); 
		//Supervisor end
