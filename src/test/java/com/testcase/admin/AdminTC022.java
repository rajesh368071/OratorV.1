...
public class AdminTC022 extends AllScenario {
	
	public void verifyGoAnonymousDisplayed() throws IOException, InterruptedException, AWTException {
		...
		assertEquals(ElementDisplayed(webchat.L_go_anonymous), true);
